 ...
 * inactive.
 */
cvox.AbstractHost.prototype.activateOrDeactivateChromeVox = async function(active) {
  await this.onStateChanged_(active ? cvox.AbstractHost.State.ACTIVE :
 ...
 */
cvox.AbstractHost.prototype.killChromeVox = async function() {
  await this.onStateChanged_(cvox.AbstractHost.State.KILLED);
};
 ...
 * @private
 */
cvox.AbstractHost.prototype.onStateChanged_ = async function(state) {
  ...
  switch (state) {
    case cvox.AbstractHost.State.ACTIVE:
      ...
      await cvox.ChromeVoxEventWatcher.init(window);
