 ...
 * @override
 */
cvox.OverlayWidget.prototype.show = async function() {
  goog.base(this, 'show');
  ...
  await cvox.ChromeVox.navigationManager.updateSelToArbitraryNode(host);
  this.host_ = host;
};
 ...
 * @override
 */
cvox.OverlayWidget.prototype.onKeyDown = async function(evt) {
  ...
  if (!cvox.DomUtil.isDescendantOfNode(
    ...
    if (r) {
      ...
      await cvox.ChromeVox.navigationManager.updateSelToArbitraryNode(this.host_);
    }
    this.onNavigate();
