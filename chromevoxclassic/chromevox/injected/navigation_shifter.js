 ...
 * @override
 */
cvox.NavigationShifter.prototype.next = async function(sel) {
  var ret = await this.currentWalker_.next(sel);
 ...
 * @override
 */
cvox.NavigationShifter.prototype.sync = async function(sel) {
  return await this.currentWalker_.sync(sel);
};
 ...
 * @override
 */
cvox.NavigationShifter.prototype.getDescription = async function(prevSel, sel) {
  return await this.currentWalker_.getDescription(prevSel, sel);
};
 ...
 * @override
 */
cvox.NavigationShifter.prototype.getBraille = async function(prevSel, sel) {
  return await this.lineWalker_.getBraille(prevSel, sel);
};
