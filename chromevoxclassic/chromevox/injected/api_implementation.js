 ...
 */
cvox.ApiImplementation.syncToNode = async function(
  ...
  await cvox.ChromeVox.navigationManager.updateSelToArbitraryNode(targetNode, true);
  ...
  if (opt_speakNode) {
    cvox.ChromeVox.navigationManager.speakDescriptionArray(
        await cvox.ApiImplementation.getDesc_(targetNode),
  ...
  cvox.ChromeVox.braille.write(await cvox.ChromeVox.navigationManager.getBraille());
 ...
 * @private
 */
cvox.ApiImplementation.getDesc_ = async function(node) {
  if (!node.hasAttribute('cvoxnodedesc')) {
    return await cvox.ChromeVox.navigationManager.getDescription();
  }
