 ...
 * @return {AutomationNode}
 */
AutomationUtil.findNextNode = async function(cur, dir, pred, opt_restrictions) {
  var restrictions = {};
 ...
 * @return {AutomationNode}
 */
AutomationUtil.findNodeUntil = async function(cur, dir, pred, opt_before) {
  var before = cur;
  var after = before;
  do {
    before = after;
    after = await AutomationUtil.findNextNode(before, dir, AutomationPredicate.leaf);
