 ...
 */
cvox.ChromeVoxHTMLDateWidget.create = async function(dateElem, tts) {
  dateWidget = new cvox.ChromeVoxHTMLDateWidget(dateElem, tts);

  await dateWidget.update_(true);
  return dateWidget;
}
 ...
 */
cvox.ChromeVoxHTMLDateWidget.prototype.update_ = async function(shouldSpeakLabel) {
  ...
  if (shouldSpeakLabel) {
    changeMessage = await cvox.DomUtil.getName(this.dateElem_, true, true) + '\n';
  }
 ...
 */
cvox.ChromeVoxHTMLDateWidget.prototype.eventHandler_ = async function(evt) {
