 ...
 * @override
 */
cvox.StructuralLineWalker.prototype.getBraille = async function(prevSel, sel) {
  var braille = goog.base(this, 'getBraille', prevSel, sel);

  var objNode = (await this.objWalker_.sync(sel)).absStart().node;
  ...
  var spannable =
      await cvox.BrailleUtil.getTemplated(prevNode, objNode, {name: name});
